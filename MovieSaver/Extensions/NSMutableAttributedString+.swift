...
extension NSMutableAttributedString {
    ...
    var boldFont:UIFont { return UIFont(name: "Manrope-Bold", size: fontSize) ?? UIFont.boldSystemFont(ofSize: fontSize) }
    var normalFont:UIFont { return UIFont(name: "Manrope-Regular", size: fontSize) ?? UIFont.systemFont(ofSize: fontSize)}
